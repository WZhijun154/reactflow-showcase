...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center bg-zinc-50 dark:bg-zinc-900">
      <header className="w-full bg-white py-8 text-center shadow-sm dark:bg-zinc-800">
      ...
      <main className="flex w-full max-w-6xl flex-1 flex-col items-center px-4 py-8">
        <section className="w-full rounded-lg bg-white p-4 shadow-md dark:bg-zinc-800">
