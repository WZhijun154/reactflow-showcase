...
export function InitialStateNode({ data }: NodeProps) {
  ...
  return (
    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-zinc-900 dark:bg-zinc-100 shadow-lg transition-all duration-200 hover:scale-110 hover:shadow-xl">
